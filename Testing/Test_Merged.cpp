...
//	MQTTVERSION_DEFAULT, (char*)"Topic/#", (char*)"paho_cs_sub", 0, 0, NULL, NULL, (char*)"localhost",(char*)"1883", NULL, 10, /* MQTT options */
//	NULL, NULL, 0, 0, /* will options */
//	0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, /* TLS options */
//	0, {NULL, NULL}, /* MQTT V5 options */
//};
//
//TEST_CASE("WildCards in Topic Name")
//{	
//	REQUIRE(wildCardCheckInTopicName(opts) == 1);
//	opts.topic = (char*)"patient";
//	REQUIRE(wildCardCheckInTopicName(opts) == 0);
//
//}
//TEST_CASE("client connected to which host")
//{
//	REQUIRE(strcmp(CheckconnectionToWhichHost(opts), "localhost:1883") == 0);
//	opts.connection = (char*)"example";
//	REQUIRE(strcmp(CheckconnectionToWhichHost(opts), "example") == 0);
//}
//
//
//
//TEST_CASE("Check Whether client connected to server or Not ")
//{
//	MQTTClient client;
//	char* url = CheckconnectionToWhichHost(opts);
//	MQTTClient_createOptions createOpts = MQTTClient_createOptions_initializer;
//	int rc;
//	rc = MQTTClient_createWithOptions(&client, url, opts.clientid, MQTTCLIENT_PERSISTENCE_NONE, NULL, &createOpts);
//	REQUIRE(rc == 0);
//	REQUIRE(CheckConnectionSuccessOrNot(client, opts)==TRUE);
//}
//
//TEST_CASE("Testing does FileHandling function writing patient details into given file name")
//{		
//	writeIntoCsvFile("testfile.csv", "Testing message", "Test Topic");
//    FILE* filePointer;
//    char dataToBeRead[50];
//    filePointer = fopen("testfile.csv", "r");
//	fgets(dataToBeRead, 50, filePointer);
//	REQUIRE(strcmp(dataToBeRead,"Test Topic,Testing message\n")==0);
//    fclose(filePointer);
//}
//
////////////*****************SUBSCRIBE TEST OVER*****************//
